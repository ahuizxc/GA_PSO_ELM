% ELM 训练网络
function [IW,B,LW,TF,TYPE] = elmtrain2(P,T,N,TF,TYPE);
...
% Randomly Generate the Input Weight Matrix 随机生成输入权重矩阵
IW = rand(N,R) * 2 - 1;
% Randomly Generate the Bias Matrix 随机生成偏差矩阵
B = rand(N,1);
